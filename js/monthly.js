	...
	$.fn.extend({
		monthly: function(options) {
			...
			var options = $.extend(defaults, options),
				...
				monthNames = ["Jan", "Fev", "Mar", "Avr", "Mai", "Juin", "Juillet", "Aout", "Sept", "Oct", "Nov", "Dec"],
				dayNames = ['Lundi', 'Mardi','Mercredi','Jeudi','Vendredi','Samedi','Vendredi'];
		...
		if (options.weekStart == 'Dimanche') {
			$('#' + uniqueId).append('<div class="monthly-day-title-wrap"><div>Dimanche</div><div>Lundi</div><div>Mardi</div><div>Mercredi</div><div>Jeudi</div><div>Vendredi</div><div>Samedi</div></div><div class="monthly-day-wrap"></div>');
		} else if (options.weekStart == 'Lundi') {
			$('#' + uniqueId).append('<div class="monthly-day-title-wrap"><div>Lundi</div><div>Mardi</div><div>Mercredi</div><div>Jeudi</div><div>Vendredi</div><div>Samedi</div><div>Dimanche</div></div><div class="monthly-day-wrap"></div>');
		} else {
